...
var normalizer = 100000000; // Use this to convert LMMCOIN amount to normal value
...
var DappGit = {
  ...
  git: "git@github.com:linkmanagement/cryptipad.git"
};
...
// Account info for foundation account - LMMCOIN > 1,000,000 | Needed for voting, registrations and Tx
var Faccount = {
...
// Random LMMCOIN Amount
var LMMCOIN = Math.floor(Math.random() * (100000 * 100000000)) + 1; // Remove 1 x 0 for reduced fees (delegate + Tx)
...
// Randomizes LMMCOIN amount
function randomizeLMMcoin(){
...
module.exports = {
  ...
  randomizeLMMcoin: randomizeLMMcoin,

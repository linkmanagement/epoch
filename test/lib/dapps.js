...
describe('Dapps', function() {
  ...
  describe('Add DApp', function() {
    ...
    test += 1;
    it(test + '.Attempting to add DApp. Valid SIA. 0 LMMCOIN account. We expect error',function(done){
        node.api.put('/dapps')
          .set('Accept', 'application/json')
          .send({
            secret: Account3.password,
    ...
    test += 1;
    it(test + '.Attempting to add DApp. Via GIT. 0 LMMCOIN account. We expect error',function(done){
      node.api.put('/dapps')
        .set('Accept', 'application/json')
        .send({
          secret: Account3.password,

...
describe("Peers delegates transactions", function () {
        ...
        node.api.put('/transactions')
          ...
          .end(function (err, res) {
            node.onNewBlock(function (err) {
              ...
              var transaction = node.lmmcoin.delegate.createDelegate(account.password, crypto.randomBytes(64).toString('hex'));
  ...
  it("Create delegate from account with no funds. Should return not ok", function (done) {
    var transaction = node.lmmcoin.delegate.createDelegate(node.randomPassword(), node.randomDelegateName());
    transaction.fee = node.Fees.delegateRegistrationFee;
        ...
        node.api.put('/transactions')
          ...
          .end(function (err, res) {
            node.onNewBlock(function (err) {
              ...
              var transaction = node.lmmcoin.delegate.createDelegate(account2.password, account2.username);
              transaction.fee = node.Fees.delegateRegistrationFee;
              ...
              node.peer.post('/transactions')
                ...
                .end(function (err, res) {
                  ...
                  account2.username = node.randomDelegateName();
                  var transaction2 = node.lmmcoin.delegate.createDelegate(account2.password, account2.username);
